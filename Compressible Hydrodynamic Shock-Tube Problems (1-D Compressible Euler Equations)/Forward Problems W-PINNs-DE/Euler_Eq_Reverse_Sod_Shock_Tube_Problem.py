"""
Forward Problem for 1-D Euler Equations for Compressible Flow: The Reverse Sod Problem
...
In this code we solve for rho, u, p  from the following equations:
                              ...
                              (rho,u,p)_t=0 = (0.125,0.0,0.1) 0 <= x < 0.5
                              (rho,u,p)_t=0 = (1.0,0.0,1.0) 0.5 <= x <=1
...
def main():
    ...
    epochs = 76139                                                        # Number of iterations
    ...
    scipy.io.savemat('Reverse_Sod_Shock_Tube.mat', {'x': x, 't': t,'rho': u_pred[:,0],
                                                              'u': u_pred[:,2],
                                                              'p': u_pred[:,1]})
