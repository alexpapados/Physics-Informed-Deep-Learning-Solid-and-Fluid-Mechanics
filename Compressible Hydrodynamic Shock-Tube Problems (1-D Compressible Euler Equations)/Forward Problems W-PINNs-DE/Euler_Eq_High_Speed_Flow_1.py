...
In this code we solve for rho, u, p  from the following equations:
                              ...
                              (rho,u,p)_t=0 = (0.445,0.698,0.70) 0 <= x < 0.5
                              (rho,u,p)_t=0 = (0.5,0.0,0.571)  0.5 <= x <=1
...
def main():
    ...
    #epochs = 62875                                                        # Number of iterations

    epochs = 67207
    num_f_train = 11000                                                   # Random sampled points in interior
    x = np.linspace(-2.625, 3.125, num_x)                                   # Partitioned spatial axis
    ...
    scipy.io.savemat('High_Speed_Flow_2.mat', {'x': x, 't': t,'rho': u_pred[:,0],
                                                              'u': u_pred[:,2],
                                                              'p': u_pred[:,1]})
